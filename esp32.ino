...
const char* strWifiSsid      = "A";
const char* strWifiPassword  = "12345678";
const char* strServerUrl     = "https://arthurfetzner.com/api.php";
...
void sendDataToServer(const std::map<unsigned long, unsigned long>& rmapMessages)
{
    reconnectWiFi();
    ...
    for (const auto& rMessage : rmapMessages)
        strPayload += String(rMessage.first) + "," + String(rMessage.second) + ";";
